...
ReportShort = d.Report;
const totalRows = [];
const shift1Key = Object.keys(ReportShort)[0];
const shift1 = ReportShort[shift1Key];
...
let shiftRow = 0;
let metricRow = 0;
Object.keys(ReportShort).forEach((shiftkey, shiftindex) => {
    let shift = ReportShort[shiftkey];
    shiftRow += 1;
